---
name: "source-command-convex-create-component"
...
# source-command-convex-create-component

Use this skill when the user asks to run the migrated source command `convex-create-component`.
