---
name: "source-command-convex-setup-auth"
...
# source-command-convex-setup-auth

Use this skill when the user asks to run the migrated source command `convex-setup-auth`.
