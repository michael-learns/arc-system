---
name: "source-command-convex-performance-audit"
...
# source-command-convex-performance-audit

Use this skill when the user asks to run the migrated source command `convex-performance-audit`.
